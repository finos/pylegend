...
# Output lines containing any of these are testcontainer/low-level noise, not doc content.
_NOISY_LOG_MARKERS = [
                            ...
                            for out in cell.outputs:
                                ...
                                if out.output_type == 'stream':
                                    ...
                                    for line in out.text.split('\n'):
                                        ...
                                        if any(x in line for x in _NOISY_LOG_MARKERS):
                                            continue
                                        valid_lines.append(line)
                                    if not valid_lines or all(not line.strip() for line in valid_lines):
                                        continue
                                    out.text = '\n'.join(valid_lines)
                                ...
                                if out.output_type == 'stream':
                                    if out.text.strip():
                                        ...
                                        for line in out.text.split('\n'):
                                            ...
                                            new_lines.append(indent + "    " + _html.escape(line))
                                    ...
                                    if 'text/html' in out.data:
                                        if out.data['text/html'].strip():
                                            new_lines.append(indent + ".. raw:: html")
                                            new_lines.append("")
                                            for line in out.data['text/html'].split('\n'):
                                                new_lines.append(indent + "    " + line)
                                            new_lines.append("")
                                        ...
                                        if out.data['text/plain'].strip():
                                            ...
                                            new_lines.append("")
                                            for line in out.data['text/plain'].split('\n'):
                                                new_lines.append(indent + "    " + line)
                                            new_lines.append("")
            else:
