...
class TruncateFunction(PandasApiAppliedFunction):
    ...
    def __init__(
            ...
            before: PyLegendUnion[str, int],
            after: PyLegendUnion[str, int],
    ...
    def validate(self) -> bool:
        ...
        if self.__copy not in [True]:
            raise ValueError(f"The 'copy' parameter of the truncate function must be True, but got: {self.__copy}")
