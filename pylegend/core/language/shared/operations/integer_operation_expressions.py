...
class PyLegendIntegerInListExpression(PyLegendNaryExpression, PyLegendExpressionBooleanReturn):
    ...
    def __init__(self, operands: PyLegendList[PyLegendExpression]) -> None:
        ...
        PyLegendNaryExpression.__init__(
            self,
            operands,
            PyLegendIntegerInListExpression.__to_sql_func,
            PyLegendIntegerInListExpression.__to_pure_func,
        )
