...
class PandasApiFirstRow(PandasApiTdsRow):
    ...
    def to_pure_expression(self, config: FrameToPureConfig) -> str:
        return (
            f"{self.__partial_frame.to_pure_expression(config)}"
            f"->first({self.__window_ref.to_pure_expression(config)}"
            f", {self.__row.to_pure_expression(config)})"
        )
...
class PandasApiLastRow(PandasApiTdsRow):
    ...
    def to_pure_expression(self, config: FrameToPureConfig) -> str:
        return (
            f"{self.__partial_frame.to_pure_expression(config)}"
            f"->last({self.__window_ref.to_pure_expression(config)}"
            f", {self.__row.to_pure_expression(config)})"
        )
...
class PandasApiNthRow(PandasApiTdsRow):
    ...
    def to_pure_expression(self, config: FrameToPureConfig) -> str:
        return (
            f"{self.__partial_frame.to_pure_expression(config)}"
            f"->nth({self.__window_ref.to_pure_expression(config)}"
            f", {self.__row.to_pure_expression(config)}, {self.__offset})"
        )
