...
class LegendApiDateTime(LegendApiDate):
    ...
    def __convert_to_datetime_expr(
            val: PyLegendUnion[datetime, "LegendApiDateTime"]
    ) -> PyLegendExpressionDateTimeReturn:
    ...
    def validate_param_to_be_datetime(
            param: PyLegendUnion[datetime, "LegendApiDateTime"],
            desc: str
    ) -> None:
        if not isinstance(param, (datetime, LegendApiDateTime)):
