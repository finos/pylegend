...
class TestJoinByColumnsAppliedFunction:
    ...
    def test_join_by_columns_error_on_non_match_col_type(self) -> None:
        ...
        frame1: LegendApiTdsFrame = LegendApiTableSpecInputFrame(['test_schema', 'test_table'], cols1)
        frame2: LegendApiTdsFrame = LegendApiTableSpecInputFrame(['test_schema', 'test_table'], cols2)
        with pytest.raises(ValueError) as r:
