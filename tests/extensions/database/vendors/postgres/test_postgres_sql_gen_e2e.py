...
class TestPostgresE2ESqlGeneration(E2EDbSpecificSqlGenerationTest):
    extension = PostgresSqlToStringGenerator.create_sql_generator().get_db_extension()

    @pytest.fixture(scope='module')
    def db_test(self):
        with PostgresContainer(driver="pg8000") as c:
