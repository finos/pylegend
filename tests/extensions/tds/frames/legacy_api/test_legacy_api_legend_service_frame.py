...
class TestLegacyApiLegendServiceFrame:

    def test_legacy_api_legend_service_frame_sql_gen(
            self,
    ...
    def test_legacy_api_legend_person_service_frame_execution(
            self,
            legend_test_server: PyLegendDict[str, PyLegendUnion[int, ]]
    ) -> None:
        frame = simple_person_service_frame_legacy_api(legend_test_server["engine_port"])
    ...
    def test_legacy_api_legend_trade_service_frame_execution(
            self,
            legend_test_server: PyLegendDict[str, PyLegendUnion[int, ]]
    ) -> None:
    ...
    def test_legacy_api_legend_product_service_frame_execution(
            self,
            legend_test_server: PyLegendDict[str, PyLegendUnion[int, ]]
    ) -> None:
