...
class TestLegacyApiLegendFunctionFrame:

    def test_legacy_api_legend_function_frame_sql_gen(
            self,
            legend_test_server: PyLegendDict[str, PyLegendUnion[int, ]]
    ) -> None:
        frame = LegacyApiLegendFunctionInputFrame(
    ...
    def test_legacy_api_legend_function_frame_execution(
            self,
            legend_test_server: PyLegendDict[str, PyLegendUnion[int, ]]
    ) -> None:
        frame = LegacyApiLegendFunctionInputFrame(
