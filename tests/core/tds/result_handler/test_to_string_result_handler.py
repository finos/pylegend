...
class TestToStringResultHandler:
    ...
    def test_to_string_result_handler_non_lazy(self) -> None:
        ...
        res = handler.handle_result(LegendQLApiTableSpecInputFrame(["dummy"], []), ResponseReader(bytes_iter))
        assert const == res
    ...
    def test_to_string_result_handler_lazy(self) -> None:
        ...
        handler = ToStringResultHandler()
        res = handler.handle_result(LegendQLApiTableSpecInputFrame(["dummy"], []), ResponseReader(gen()))
