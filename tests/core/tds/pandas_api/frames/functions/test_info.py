...
class TestInfoFunction:
    ...
    def test_e2e_info_function_trade(self, legend_test_server: PyLegendDict[str, PyLegendUnion[int,]]) -> None:
        ...
        expected_verbose = (
            '<class '
            "'pylegend.extensions.tds.pandas_api.frames.pandas_api_legend_service_input_frame.PandasApiLegendServiceInputFrame'>\n"
