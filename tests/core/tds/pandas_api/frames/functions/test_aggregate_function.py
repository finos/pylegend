...
class TestAggregateFunctionAssignment:
    ...
    def test_chaining_after_aggregate_assignment(self) -> None:
        ...
        ''').strip()  # noqa: E501
        assert dropped.to_sql_query() == expected_dropped_sql
