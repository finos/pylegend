...
class TestTakeAppliedFunction:

    def test_sql_gen_take_function_no_top(self) -> None:
        columns = [
    ...
    def test_sql_gen_take_function_existing_top(self) -> None:
        columns = [
            PrimitiveTdsColumn.integer_column("col1"),
            PrimitiveTdsColumn.string_column("col2")
        ]
    ...
    def test_take_function_negative_row_count_error(self) -> None:
        columns = [
            PrimitiveTdsColumn.integer_column("col1"),
            PrimitiveTdsColumn.string_column("col2")
        ]
