...
class TestPreciseIntegerTypes:
    ...
    def test_col_access(self, col_factory, type_name) -> None:
        frame, row = self.__make_frame(col_factory)
        assert self.__pure(frame, row, type_name, lambda x: x.get_integer("col1")) == '$t.col1'
    ...
    def test_add(self, col_factory, type_name) -> None:
        frame, row = self.__make_frame(col_factory)
        assert self.__pure(frame, row, type_name,
                           lambda x: x.get_integer("col1") + x.get_integer("col2")) == \
               '(toOne($t.col1) + toOne($t.col2))'
        assert self.__pure(frame, row, type_name, lambda x: x.get_integer("col1") + 5) == \
               '(toOne($t.col1) + 5)'
    ...
    def test_subtract(self, col_factory, type_name) -> None:
        frame, row = self.__make_frame(col_factory)
        assert self.__pure(frame, row, type_name, lambda x: x.get_integer("col1") - 3) == \
               '(toOne($t.col1) - 3)'
    ...
    def test_multiply(self, col_factory, type_name) -> None:
        frame, row = self.__make_frame(col_factory)
        assert self.__pure(frame, row, type_name, lambda x: x.get_integer("col1") * 2) == \
               '(toOne($t.col1) * 2)'
    ...
    def test_lt(self, col_factory, type_name) -> None:
        frame, row = self.__make_frame(col_factory)
        assert self.__pure(frame, row, type_name, lambda x: x.get_integer("col1") < 10) == \
               '($t.col1 < 10)'
    ...
    def __pure(self, frame, row, type_name, f) -> str:
...
class TestPreciseFloatTypes:
    ...
    def test_col_access(self, col_factory, type_name) -> None:
        frame, row = self.__make_frame(col_factory)
        assert self.__pure(frame, row, type_name, lambda x: x.get_float("col1")) == '$t.col1'
    ...
    def test_add(self, col_factory, type_name) -> None:
        frame, row = self.__make_frame(col_factory)
        assert self.__pure(frame, row, type_name, lambda x: x.get_float("col1") + 0.5) == \
               '(toOne($t.col1) + 0.5)'
    ...
    def test_subtract(self, col_factory, type_name) -> None:
        frame, row = self.__make_frame(col_factory)
        assert self.__pure(frame, row, type_name, lambda x: x.get_float("col1") - 1.5) == \
               '(toOne($t.col1) - 1.5)'
    ...
    def test_multiply(self, col_factory, type_name) -> None:
        frame, row = self.__make_frame(col_factory)
        assert self.__pure(frame, row, type_name, lambda x: x.get_float("col1") * 2.0) == \
               '(toOne($t.col1) * 2.0)'
    ...
    def test_gt(self, col_factory, type_name) -> None:
        frame, row = self.__make_frame(col_factory)
        assert self.__pure(frame, row, type_name, lambda x: x.get_float("col1") > 3.14) == \
               '($t.col1 > 3.14)'
